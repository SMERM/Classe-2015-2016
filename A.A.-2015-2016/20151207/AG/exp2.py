...
def accelerando(t0, t1, w0, w1, freq):
	...
	ap= math.log(p1)-math.log(p0)/(ftime) 
	...
	while (at < t0+ftime):
		...
		step= w*p
		dur= w-step
		print "i1 %8.4f %8.4f %8.4f ;w= %7.4f, p= %7.4f, step= %7.4f" % (at, dur, freq, w, p, step) # %8.4f argomenti che vengono sost nella stringa
		at= at+w
	print "i1 %8.4f %8.4f %8.4f" % (at, totdur-ftime, freq) # %8.4f argomenti che vengono sost nella stringa
