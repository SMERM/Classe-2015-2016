...
while (at < ftime):
	...
	step= w
	dur= (w*p)-step #n.a: ho dovuto modificare le formule della durata e dello step dato che, per una questione di calcoli, avevo uno step<0 e dunque non avevo uno step (non si sentivano nella traccia gli stacchi).
