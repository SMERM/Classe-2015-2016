...
def accelerando(t0,t1,w0,w1):
	...
	ap= (math.log(p1)-math.log(p0))/(ftime) # decrescita esponenziale del rapporto tra dur e step
	...
	while (at < (t0+ftime)):
		...
		p= math.exp((ap*at)+bp) # seconda funzoine lineare (dur/step)
		step= w*p
		dur= w-step
		print "i1 %8.4f %8.4f %8.4f ; w= %7.4f, p= %7.4f, step= %7.4f" % (at, dur, at, w, p, step) 
		at= at+w
	print "i1 %8.4f %8.4f %8.4f" % (at, totdur-ftime, at)
